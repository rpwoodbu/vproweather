...
/*	v0.2 - fixed baud rate setting problem, removed baud rate cmd line		*/
/*         parm because I don't have thhe time right now to track it down.	*/
/*	v0.3 - Added forecast rule strings										*/
